...
t_start_series = pd.date_range(pd.to_datetime("2020-01-01"), periods=2, freq="AS")
t_end_series = pd.date_range(pd.to_datetime("2020-12-31"), periods=2, freq="A")
f_time_series = pd.date_range(pd.to_datetime("2020"), periods=2, freq="1Y")
