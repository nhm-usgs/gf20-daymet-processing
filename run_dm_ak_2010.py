...
t_start_series = pd.date_range(pd.to_datetime("2010-01-01"), periods=10, freq="AS")
t_end_series = pd.date_range(pd.to_datetime("2010-12-31"), periods=10, freq="A")
f_time_series = pd.date_range(pd.to_datetime("2010"), periods=10, freq="1Y")
