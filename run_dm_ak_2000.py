...
# t_start_series = pd.date_range(pd.to_datetime("2000-01-01"), periods=10, freq="AS")
# t_end_series = pd.date_range(pd.to_datetime("2000-12-31"), periods=10, freq="A")
# f_time_series = pd.date_range(pd.to_datetime("2000"), periods=10, freq="1Y")

t_start_series = pd.date_range(pd.to_datetime("2008-01-01"), periods=2, freq="AS")
t_end_series = pd.date_range(pd.to_datetime("2008-12-31"), periods=2, freq="A")
f_time_series = pd.date_range(pd.to_datetime("2008"), periods=2, freq="1Y")
