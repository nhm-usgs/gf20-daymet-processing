...
t_start_series = pd.date_range(pd.to_datetime("1990-01-01"), periods=10, freq="AS")
t_end_series = pd.date_range(pd.to_datetime("1990-12-31"), periods=10, freq="A")
f_time_series = pd.date_range(pd.to_datetime("1990"), periods=10, freq="1Y")
